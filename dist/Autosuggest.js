...
var Autosuggest = (function (_Component) {
  ...
  _createClass(Autosuggest, [{
    ...
    value: function setSuggestionsState(suggestions, cb) {
    ...
    value: function onInputKeyDown(event) {
      ...
      switch (event.keyCode) {
        case 13:
          ...
          var suggestion = this.getSuggestion(this.state.focusedSectionIndex, this.state.focusedSuggestionIndex);
          ...
          this.setSuggestionsState(null, function () {
    ...
    value: function onSuggestionMouseDown(sectionIndex, suggestionIndex, event) {
      ...
      this.setState({
        ...
        // This code executes after the component is re-rendered
        setTimeout(function () {
          _React$Component$PropTypes$findDOMNode.findDOMNode(_this2.refs.input).focus();
          _this2.onSuggestionSelected(suggestion, event);
        });
      });
    }
  }, {
